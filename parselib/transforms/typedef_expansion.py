...
class TypedefExpansion(TopDown):
    ...
    def __get_expandable_var_from_tree(self, tree):
        ...
        if tree.data == 'hliteral':
            ...
            assert tree.children[1].data == 'hliteral'
    ...
    def __expand_blkassign(self, tree):
        ...
        if lhs_var is not None and (rhs_var is not None or rhs.data == 'hunimp'):
            ...
            if rhs.data != 'hunimp':
                ...
                assert rhs.children[0] == 'CXXDefaultArgExpr'
